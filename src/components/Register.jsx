...
const Register = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            setMessage(<p className='text-sm font-semibold red-600 pb-2'>Please provide a valid email and password</p>);
            console.log(error)
        }
    }
    ...
    const handleGoogleSignIn = async () => {
        try {
            ...
            setMessage(<p className='text-sm font-semibold red-600 pb-2'>Google sign in failed!</p>);
            console.log(error)
        }
    }
    ...
    <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <div className='mt-4'>
                ...
                className='w-full flex flex-wrap gap-1 justify-center items-center bg-secondary
                hover:bg-blue-900 text-white font-bold py-2 px-4 rounded focus:outline-none'>
