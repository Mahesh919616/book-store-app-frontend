...
const CheckoutPage = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            console.log("Error to place an order", error);
                            ...
                            <div className="lg:col-span-2">
                                <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    ...
                                    <div className="md:col-span-5">
                                        ...
                                        <input {...register("phone", { required: true })} autoComplete='off'
                                    ...
                                    <div className="md:col-span-3">
                                        ...
                                        <input {...register("address", { required: true })} autoComplete='off'
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <div className="h-10 bg-gray-50 flex border border-gray-200 rounded items-center mt-1">
                                            <input {...register("country", { required: true })} autoComplete='off'
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <div className="h-10 bg-gray-50 flex border border-gray-200 rounded items-center mt-1">
                                            <input {...register("state", { required: true })} autoComplete='off'
                                    ...
                                    <div className="md:col-span-1">
                                        ...
                                        <input {...register("zipcode", { required: true })} autoComplete='off'
                                    ...
                                    <div className="md:col-span-5 mt-3">
                                        <div className="inline-flex items-center">
                                            <input onChange={() => setIsChecked(!isChecked)}
                                    ...
                                    <div className="md:col-span-5 text-right">
                                        <div className="inline-flex items-end">
                                            ...
                                            disabled:bg-slate-400 disabled:cursor-default">Place an Order</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
