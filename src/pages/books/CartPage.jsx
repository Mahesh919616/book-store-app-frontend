        ...
        <div className="flex mt-12 h-full flex-col overflow-hidden bg-white shadow-xl">
            ...
            <div className="flex items-start justify-between">
                ...
                <button disabled={cartItems.length == 0}
                    ...
                    className="disabled:bg-slate-400 disabled:cursor-default
                    relative m-2 py-1 px-2 bg-red-500 text-white rounded-md hover:bg-secondary transition-all duration-200 ">
            ...
            <div className="mt-6">
                ...
                to="/checkout"
                >
                    <button disabled={cartItems.length == 0} className='disabled:bg-slate-400 disabled:cursor-default w-full
